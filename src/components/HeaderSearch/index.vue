  ...
  methods: {
    ...
    generateRoutes(routes, basePath = '/', prefixTitle = []) {
      ...
      for (const router of routes) {
        const data = {
          // path: !this.ishttp(router.url) ? path.resolve(basePath, router.url) : router.url,
          path: router.url,
          title: [...prefixTitle]
        }
...
/deep/ .el-select .el-input.is-focus .el-input__inner:focus {
  border-color: rgb(175, 17, 30);
}
