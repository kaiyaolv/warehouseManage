<template>
	<div >
		...
		<el-table :data="data.content" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange"
			...
			:align="align" style="width:100%;" ref="multipleTable">
		...
		<!-- <div >
			...
			<div class="pageinatiaon">

				<el-pagination background @size-change="size_change" layout="total, prev,sizes, pager, next , jumper"
					@current-change="refreshPageRequest" :current-page="pageRequest.pageNum" :page-size="20"
					:total="data.totalSize" style="float:right;" :page-sizes="[10,20,30,40,50,100]">
				</el-pagination>
			</div>
		</div> -->
	</div>
