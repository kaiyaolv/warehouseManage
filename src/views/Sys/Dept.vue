  ...
  <div class="page-container">
    ...
    <el-table :data="tableTreeDdata" stripe size="mini" style="width: 100%;"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <kt-button icon="fa fa-edit" type='success' :label="$t('action.edit')" perms="sys:dept:edit" @click="handleEdit(scope.row)"/>
    ...
    <el-dialog :title="!dataForm.id ? '新增' : '修改'" width="466px" :visible.sync="dialogVisible" :close-on-click-modal="false">
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="submitForm()"
        label-width="80px" :size="size" style="text-align:left;position: relative; left: 16px;">
        <el-form-item label="名称" prop="name">
          <el-input v-model="dataForm.name" placeholder="名称" class="inputItem"></el-input>
        </el-form-item>
        ...
        <el-form-item v-if="dataForm.type !== 2" label="排序编号" prop="orderNum">
          <el-input-number v-model="dataForm.orderNum" controls-position="right" :min="0" label="排序编号" class="selectItem"></el-input-number>
        </el-form-item>
      </el-form>
      <div  class="footItem">
